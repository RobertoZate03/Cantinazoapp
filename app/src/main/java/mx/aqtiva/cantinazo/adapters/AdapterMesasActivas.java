 ...
 */
public class AdapterMesasActivas extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_HEADER = 0;
    private static final int TYPE_ITEM = 1;
    protected SharedPreferences sp;
    //Header header;
    List<ListaMesasActiva> list;
    Context contx;

    public AdapterMesasActivas(Context context, List<ListaMesasActiva> headerItems) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof VHHeader) {
            ListaMesasActiva currentItem = list.get(position);
            ...
            if(position == 0){
                ...
                SpannableString spanString1 = new SpannableString("ACUMULADO");
            ...
            VHheader.btnVer.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    private boolean isPositionHeader(int position) {
        ...
        return list.get(position) instanceof ListaMesasActiva;
