...
public class AdapterProductos extends ArrayAdapter<ListaProductos> {

    LayoutInflater inflater;
    Context context;

    public AdapterProductos(Context context, int resource, List objects) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        final ListaProductos object = getItem(position);
