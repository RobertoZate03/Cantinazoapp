...
public class ListaMesasActiva {
    ...
    public ListaMesasActiva(String id, String monto_total, String mesa, String fecha_venta, String pagado, String usuario_id, String usuario_name, String sucursal_id, String sucursal_name, String tipo_pago_id, String tipo_pago_name, String terminado) {
        this.id = id;
